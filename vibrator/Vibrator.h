...
public:
  Vibrator(std::ofstream&& enable, std::ofstream&& duration, std::ofstream&& amplitude, std::ofstream&& amplitude_call, std::ofstream&& amplitude_notif);
...
private:
  ...
  std::ofstream mAmplitudeCall;
  std::ofstream mAmplitudeNotif;
};
